...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__out(const void *p[])
{
...
PyInit__out(void)
{
  return _cffi_init("package._out", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_out(void)
{
  _cffi_init("package._out", 0x2601, &_cffi_type_context);
}
#endif
